...
describe('accountReducers', () => {
    ...
    it('should return state with modified account', () => {
        ...
        const currentAccountID: string = uuidv4();
        const currentAccount = { id: currentAccountID, name: "Name", type: AccountType.Credit, startBalance: 0, startDate: date };
        const currentState = [currentAccount];
        const modifiedAccount = { id: currentAccountID, name: "Name2", type: AccountType.Credit, startBalance: 0, startDate: date };
