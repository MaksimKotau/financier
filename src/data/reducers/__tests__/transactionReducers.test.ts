...
describe('TransactionReducer', () => {
    it('should return state with new transaction', () => {
        ...
        const currentTransaction: TransactionDTO = { id: transactionID, date: moment(), value: 100, transactionCategoryID: uuidv4() };
    ...
    it('should return state with modified transaction', () => {
        const transactionID: string = uuidv4();
        const currentTransaction: TransactionDTO = { id: transactionID, date: moment(), value: 100, transactionCategoryID: uuidv4() };
        const modifiedTransaction: TransactionDTO = { id: transactionID, date: moment(), value: 110, transactionCategoryID: uuidv4() };
