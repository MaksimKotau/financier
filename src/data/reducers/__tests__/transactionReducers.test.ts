...
describe('TransactionReducer', () => {
    it('should return state with new transaction', () => {
        ...
        const currentTransaction: TransactionDTO = { id: transactionID, date: "2020-02-16", value: 100, transactionCategoryID: uuidv4() };
        ...
        expect(transactionReducer(undefined, currentAction)).toEqual(expectedState);
    })
    it('should return state with modified transaction', () => {
        const transactionID: string = uuidv4();
        const currentTransaction: TransactionDTO = { id: transactionID, date: "2020-02-16", value: 100, transactionCategoryID: uuidv4() };
        const modifiedTransaction: TransactionDTO = { id: transactionID, date: "2020-02-16", value: 110, transactionCategoryID: uuidv4() };
