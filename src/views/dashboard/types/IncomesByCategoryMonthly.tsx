...
import {getAllIncomesByCategoriesMonthly} from '../../../services/balanceService';
...
const IncomesByCategoryMonthly: React.FC<OwnProps> = ({id, type}) => {
    const palette = new ColorChooser();
    const data = getAllIncomesByCategoriesMonthly(moment().subtract(1, 'year').format("YYYY-MM-DD"),moment().format("YYYY-MM-DD"))
...
export default IncomesByCategoryMonthly;